...
const ContactLeft = () => {
  return (
    <div className="xs:mb-5 w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#595959] to-[#404040] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
      <img
        className="xs:w-full max-h-[700px] lgl:w-full h-45 object-cover rounded-lg"
        src={meTwo}
        alt="edenImage"
      />
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-base text-lightText tracking-wide">
          A passionate and results-driven Front-end developer dedicated to
          crafting exceptional, high-quality websites. I bring a distinctive mix
          of creativity and technical know-how to every project I take on
        </p>
        ...
        <p className="text-base text-white flex items-center gap-2">
          ...
          <span className="text-lightText">
            <a href="mailto:edenwong.work@gmail.com">edenwong.work@gmail.com</a>
          </span>
        </p>
        <p className="text-base text-white flex items-center gap-2">
          <FaLocationDot />
